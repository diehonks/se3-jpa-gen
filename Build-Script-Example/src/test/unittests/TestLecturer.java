...
public class TestLecturer {
	...
	@Test(groups = {"TestLecturer"},dependsOnGroups = {"TestCourse"})
	public void createLecturer() {
		lecturerDAO.deleteAllLecturer();
	...
	@Test(groups = {"TestLecturer"},dependsOnGroups = {"TestCourse"},dependsOnMethods = "createLecturer")
	...
	@Test(groups = {"TestLecturer"},dependsOnGroups = {"TestCourse"},dependsOnMethods = "readLecturer")
	...
	@Test(groups = {"TestLecturer"},dependsOnGroups = {"TestCourse"},dependsOnMethods = "updateLecturer")
