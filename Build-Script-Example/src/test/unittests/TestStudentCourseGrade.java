...
public class TestStudentCourseGrade {
	...
	@Test(groups = {"TestStudentCourseGrade"},dependsOnGroups = {"TestStudent"})
	public void createStudentCourseGrade() {
		courseGradeDAO.deleteAllStudentCourseGrades();
	...
	@Test(groups = {"TestStudentCourseGrade"},dependsOnGroups = {"TestStudent"}, dependsOnMethods = "createStudentCourseGrade")
	...
	@Test(groups = {"TestStudentCourseGrade"},dependsOnGroups = {"TestStudent"}, dependsOnMethods = "readStudentCourseGrade")
	...
	@Test(groups = {"TestStudentCourseGrade"},dependsOnGroups = {"TestStudent"}, dependsOnMethods = "updateStudentCourseGrade")
