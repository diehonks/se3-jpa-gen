...
public class TestAddress {
	...
	@Test(groups = {"TestAddress"})
	public void createAddress() {
		addressDAO.deleteAllAddresss();
	...
	@Test(groups = {"TestAddress"},dependsOnMethods = "createAddress")
	...
	@Test(groups = {"TestAddress"},dependsOnMethods = "updateAddress")
